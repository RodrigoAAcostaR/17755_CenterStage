...
public class AutoRojoLargo extends LinearOpMode {
    ...
    public void rojoMedio(){
        ...
        turnToHeading(TURN_SPEED, 180);
        driveStraight(DRIVE_SPEED, -19, 180);
        turnToHeading(TURN_SPEED, 90);
        driveStraight(DRIVE_SPEED, -19, 90);
        setPosition(4200);
        sleep(2000);
        driveStraight(VELOCIDADBACKDROP, -4, -90);
        sleep(1000);
        leave();
        sleep(1500);
        driveStraight(VELOCIDADBACKDROP, 2, -90);
